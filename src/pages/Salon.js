        ...
        <Card style={{ width: '80rem' }}>
          ...
          <Row className='d-flex justify-content-center'>
            <h5>Bem vindo(a) {this.state.waiter}, <Link to='/'><Button color='warning'
              onClick={this.clickSignOut}><i className='fas fa-sign-out-alt'></i> Sair</Button></Link></h5>
          </Row>
          <Row>
            <Col>
              <Accordion>
                <Card style={{ width: '40rem' }}>
                  ...
                  <CardHeader>
                    <AccordionToggle as={Link} eventKey='0'><i className='fas fa-coffee'></i> Café da Manhã</AccordionToggle>
                  </CardHeader>
                              ...
                              return <p className='d-flex justify-content-around'>
                                ...
                                <p>
                                  <Button key={index} onClick={() => this.clickBuy(product)}
                                    color='success' className='btn-circle'><i className='fas fa-plus'></i></Button>
                                </p>
                              </p>})}
                          </Card>
                        </Col>
                  ...
                  <CardHeader>
                    <AccordionToggle as={Link} eventKey='1'><i className='fas fa-hamburger'></i> Hambúrgueres</AccordionToggle>
                  </CardHeader>
                  ...
                  <CardHeader>
                    <AccordionToggle as={Link} eventKey='2'><i className='fas fa-cookie-bite'></i> Acompanhamentos</AccordionToggle>
                  </CardHeader>
                  ...
                  <CardHeader>
                    <AccordionToggle as={Link} eventKey='3'><i className='fas fa-glass-cheers'></i> Bebidas</AccordionToggle>
                  </CardHeader>
                  ...
                  <CardHeader>
                    <AccordionToggle as={Link} eventKey='4'><i className='far fa-plus-square'></i> Adicionais</AccordionToggle>
                  </CardHeader>
            ...
            <Col>
              <Card style={{ width: '35rem ' }}>
                <CardHeader>
                  <h3><i className='fas fa-shopping-cart'></i> Pedido</h3>
                </CardHeader>
                <Row>
                  <Col>
                    <Col>
                      ...
                      {this.state.buy.map((product, index) => {
                        return <Col key={index} className='d-flex justify-content-between'>
                          ...
                          <p><Button onClick={() => this.clickDelete(product)}
                            className='btn-circle' color='danger'><i className='fas fa-minus'></i></Button>
                            <Button color='default'>{product.quantidade} </Button>
                            <Button onClick={() => this.clickBuy(product)}
                              className='btn-circle' color='success'><i className='fas fa-plus'></i></Button></p>
                        </Col>})}
                    </Card>
                  </Col>
                </Row>
                <Row>
                  <Col>
                    <CardFooter className='d-flex justify-content-between'>
                      <h5><i className='fas fa-money-check-alt'></i> Total R$ {total}</h5>
                      <Button color='warning' onClick={this.clickSubmit}><i className='fas fa-share-square'></i> Enviar</Button>
                    </CardFooter>
                  </Col>
                </Row>
              </Card>
